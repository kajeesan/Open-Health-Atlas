...
This is the maintainer procedure for **0.2.5, macOS Apple silicon (arm64)**.
...
oha_output=$(mktemp -d /private/tmp/oha-release-0.2.5.XXXXXX)
...
`openhealthatlas-0.2.5-source-<full-source-commit>.zip` alongside the installer.
